...
# Minimal script to create Figure 5b without Mixed result bars
# Writes: figs/fig-5/plot/new-fig-5b.pdf
...
pdf(file.path(output_dir, "new-fig-5b.pdf"), width = 7.09, height = 3.55)
print(fig_tusco)
dev.off()

message("Saved new-fig-5b.pdf to ", output_dir)
